...
async function POST(req) {
    try {
        ...
        const { patient_id, doctor_id, clinic_id, slot_id, room_id, payment_amount, payment_method } = await req.json();
        if (!patient_id || !doctor_id || !clinic_id || !slot_id || !room_id) {
...
async function GET(req) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$ClincsManagmentSystem$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(appointments, {
            status: 200
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d8a034de._.js.map