...
function ToastProvider({ children }) {
    ...
    function addToast(t) {
        ...
        // Longer display for errors; default is 5s
        const duration = t.type === 'error' ? 8000 : 5000;
...
function Layout({ children }) {
    ...
    // Fetch current user from /api/auth/me (cookie-based auth)
    ...
    const handleLogout = async ()=>{
        try {
            ...
            // Clean up old localStorage data (backwards compatibility)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eee4ae57._.js.map