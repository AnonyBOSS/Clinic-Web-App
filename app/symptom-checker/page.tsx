            ...
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 mt-2">
                        Describe your symptoms and our AI will suggest which specialist you should see.
                    </p>
                </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Example: I've been having headaches for the past 3 days, especially in the morning. I also feel dizzy when I stand up quickly..."
                                    rows={5}
                            ...
                            <p className="text-xs text-slate-500 dark:text-slate-400 text-center">
                                ⚠️ This is not a medical diagnosis. Always consult with a healthcare professional.
                            </p>
                        </form>
                    </div>
                ) : (
                    ...
                    <div className="space-y-6">
                        ...
                        {result.analysis.urgencyLevel === "EMERGENCY" && (
                            <div className="bg-red-600 text-white px-6 py-4 rounded-xl flex items-center gap-4 animate-pulse">
                                ...
                                <div>
                                    <p className="font-bold text-lg">Urgent Medical Attention Recommended</p>
                                    <p>Based on your symptoms, please consider seeking immediate medical care.</p>
                                </div>
                            </div>
                        )}
                        ...
                        <div className="bg-white dark:bg-dark-800 rounded-2xl shadow-lg border border-slate-200 dark:border-dark-700 p-6">
                            ...
                            {result.analysis.followUpQuestions && result.analysis.followUpQuestions.length > 0 && (
                                <div className="bg-slate-50 dark:bg-dark-700 rounded-lg p-4">
                                    <h3 className="text-sm font-medium text-slate-600 dark:text-slate-400 mb-2">
                                        Questions to consider for your doctor visit:
                                    </h3>
                                        ...
                                        >
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center gap-4 mt-1 text-sm text-slate-500 dark:text-slate-400">
                                                    ...
                                                    <span>📅 {doc.availableSlots} slots available</span>
                                                </div>
                                            </div>
                                            <button
